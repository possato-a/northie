...
export interface CapitalScoreDimensions {
...
export interface CapitalScoreResult {
    score: number;
    dimensions: CapitalScoreDimensions;
...
export async function calculateCapitalScore(profileId: string): Promise<CapitalScoreResult> {
    const now = new Date();
    ...
    const dimensions: CapitalScoreDimensions = {
