...
const fmtNum = (n, d = 2) => n.toLocaleString('pt-BR', { minimumFractionDigits: d, maximumFractionDigits: d });
const FREQ_LABEL = {
...
function buildEmailHtml(opts) {
    ...
    // Próximos passos
    const nextSteps = ai.proximos_passos.slice(0, 4).map((p, i) => `<li style="margin:8px 0;font-size:13px;color:#374151;"><span style="color:#1a7fe8;font-weight:700;">${i + 1}.</span> ${p}</li>`).join('');
    // Variação de receita
