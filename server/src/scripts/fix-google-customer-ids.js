...
if (!integrations?.length) {
    console.error('Nenhuma integração Google ativa encontrada.');
    process.exit(1);
}
...
const updatePayload = { google_customer_ids: leafIds };
if (mccId)
    updatePayload.google_login_customer_id = mccId;
...
//# sourceMappingURL=fix-google-customer-ids.js.map